...
public class SendMoney {
    ...
    public SendMoney(double amount, String appid, String clientreference, String clienttransid, String description, String nickname, String paymentoption, String walletnumber) {
        this.amount = amount;
        this.appid = appid;
