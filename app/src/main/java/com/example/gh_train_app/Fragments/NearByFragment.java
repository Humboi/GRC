...
import com.example.gh_train_app.Activities.ShowPlacesOnMapActivity;
import com.example.gh_train_app.Adapters.PlaceRecyclerViewAdapter;
import com.example.gh_train_app.OthersFiles.GoogleApiService;
import com.example.gh_train_app.OthersFiles.PlacesConstant;
import com.example.gh_train_app.OthersFiles.RetrofitBuilder;
...
//                Toast.makeText(getContext(), String.valueOf(position), Toast.LENGTH_SHORT).show();
        ...
        linearLayoutShowOnMap.setOnClickListener(view12 -> {
